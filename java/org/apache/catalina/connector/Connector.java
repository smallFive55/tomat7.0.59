...
public class Connector extends LifecycleMBeanBase  {
    ...
    public Connector(String protocol) {
        // 根据protocol设置protocolHandlerClassName类型
        setProtocol(protocol);
        // Instantiate protocol handler
        try {
            // 调用具体的 ProtocolHandler实例，如：Http11Protocol 构造实现
    ...
    protected void startInternal() throws LifecycleException {
        ...
        try {
            // 构造时的 ProtocolHandler实例，如：Http11Protocol
        ...
        // Connector维护了相关的host、context、warpper（Servlet），以便接收到请求后对请求的映射处理
