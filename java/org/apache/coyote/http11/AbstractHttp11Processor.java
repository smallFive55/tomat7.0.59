...
public abstract class AbstractHttp11Processor<S> extends AbstractProcessor<S> {
     ...
     * streams.
     *
     * 根据socket请求解析后，封装为Request与Response对象的过程
     *
        ...
        while (!getErrorState().isError() && keepAlive && !comet && !isAsync() &&
            ...
            if (!getErrorState().isError()) {
                try {
                    ...
                    // 调用适配器service方法，处理请求与响应。
                    // adapter在org.apache.coyote.http11.Http11Processor.createProcessor中配置
                    // 而 Http11Protocol.adapter 来自于 Connector.initInternal()
